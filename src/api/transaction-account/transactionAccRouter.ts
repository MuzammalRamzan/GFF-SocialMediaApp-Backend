...
import { createTransactionAccountValidation } from './validation'
...
transactionAccRouter.post('/add', authMiddleware, createTransactionAccountValidation, transactionAccController.createTransactionAccount as Application)
