...
transactionCategoryRouter.post(
	'/add',
	authMiddleware,
	transactionCategotryController.createTransactionCategory as Application
)
...
transactionCategoryRouter.put(
	'/update/:id',
	authMiddleware,
	transactionCategotryController.updateTransactionCategoryById as Application
)
transactionCategoryRouter.delete(
	'/delete/:id',
	authMiddleware,
	transactionCategotryController.deleteTransactionCategory as Application
)
